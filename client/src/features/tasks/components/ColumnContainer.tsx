...
const ColumnContainer: React.FC<Props> = ({ column, tasks, columnColor }) => {
  ...
  return (
    <div key={column} ref={setNodeRef} style={style} className="w-[290px] rounded-md flex flex-col font-Inter">
      {/* Column title */}
      <div className={`text-sm ${bgColumnHeader} h-[80px] rounded-md px-4 py-3 font-bold flex flex-col`}>
        ...
        <div className="flex text-stone-500 font-medium my-3 mx-2 cursor-pointer">+ add task</div>
      </div>
